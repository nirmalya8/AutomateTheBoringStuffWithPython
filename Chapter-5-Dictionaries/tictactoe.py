'''
This program is a simpler version of the
game TictacToe, which consists of a board
with a 9X9 grid. Players choose either 'O'
or 'X'. If three(3) of these symbols occur in
the same straight line or in one of the diagonals
the player who chose that particular symbol wins
